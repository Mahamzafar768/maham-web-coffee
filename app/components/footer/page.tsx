    ...
    <footer className="bg-[#FFF8DB] py-10">
      <div className="container mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-4 text-center lg:text-left">
          ...
          <address className="not-italic text-[#3D1403] text-sm md:text-base">
            123 Coffee St.<br />
        ...
        <div className="space-y-4 text-center lg:text-left">
          ...
          <p className="text-[#3D1403] font-outfit text-sm md:text-base">Mon - Fri: 8:00 AM - 10:00 PM</p>
          <p className="text-[#3D1403] font-outfit text-sm md:text-base">Sat - Sun: 9:00 AM - 12:00 AM</p>
          
          <h3 className="text-lg font-semibold mt-4 text-[#3D1403] font-outfit">Contact Us</h3>
          <p className="text-[#3D1403] font-outfit flex items-center justify-center lg:justify-start text-sm md:text-base">
            <HiPhone className="h-6 w-6 mr-2 text-[#3D1403]" /> +1 (123) 456-7890
          </p>
        </div>
      </div>
      
      <div className="text-center mt-8 text-[#3D1403] font-outfit text-sm md:text-base">
        &copy; {new Date().getFullYear()} M Suleman. All rights reserved.
      </div>
    </footer>
  );
};
